...
// Import logo images (Paths must be correct in your project)
...
function CountingStat({ endValue, label, duration = 2000 }) {
    ...
    return (
        <div className="stat-item" ref={ref}>
            <p className="stat-number">{currentValue}{suffix}</p>
...
const featuredLogos = [
    ...
    { id: 3, name: 'FORTUNE MAGAZINE', src: fortuneMagazineLogo, alt: 'FORTUNE MAGAZINE Logo' },
];
            ...
            <div className="clients-content-wrapper">
                ...
                <div className="featured-container">
                    ...
                    <div className="logos-wrapper">
                        {featuredLogos.map((logo, index) => ( // Add index for ref
                            <div 
                                key={logo.id} 
